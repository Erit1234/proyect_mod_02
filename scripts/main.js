...
// Inicializar variables
 ...
 function startTimer() { document.getElementById('startButton').style.display = 'none'; // Ocultar botón "Comenzar" 
      ...
      document.getElementById('result').innerText = `Total de clics: ${clicks}`;
       document.getElementById('clickCircle').style.pointerEvents = 'none';
        document.getElementById('nextButton').style.display = 'block'; // Mostrar botón "Siguiente"
         } }, 1000); } // Contar los clics en el círculo
          document.getElementById('clickCircle').addEventListener('click', function() { 
            clicks++; this.innerText = clicks; }); // Iniciar la secuencia al hacer clic en el botón "Comenzar" 
 ...
 document.getElementById('nextButton').addEventListener('click', function() { window.location.href = "reto_2.html"; // Cambia la URL a la página de destino 
  });